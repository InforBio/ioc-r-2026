...
If you have a Slack account, you can either connect to the account using this [webpage](https://slack.com/signin#/signin), or use a desktop version on your computer. ([Slack Windows desktop](https://slack.com/intl/fr-fr/downloads/windows), [Slack Mac desktop](https://apps.apple.com/us/app/slack-for-desktop/id803453959?mt=12))
