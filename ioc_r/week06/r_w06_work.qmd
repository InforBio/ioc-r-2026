...
For this homework, we will use the [Palmer Penguins dataset](https://allisonhorst.github.io/palmerpenguins/){target='_blank'}.
...
Create a new R Project called `penguins_analysis` and save the dataset file [penguins.csv](https://raw.githubusercontent.com/allisonhorst/palmerpenguins/master/inst/extdata/penguins.csv){target='_blank'} inside a folder named `data` in your project.
...
[link](https://raw.githubusercontent.com/InforBio/ioc-r-2026/refs/heads/main/ioc_r/week06/.r_w06_work_corr.R){target='_blank'}