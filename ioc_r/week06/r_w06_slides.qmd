...
![](https://imgs.xkcd.com/comics/3x9.png){.nostretch}

Click [this link](https://app.wooclap.com/UBZAPL/questionnaires/68b1b13144df9e61ac1f4172) to start the test, you have 30 minutes.


## Test Your Level {.smaller}

<iframe allowfullscreen frameborder="0" height="80%" mozallowfullscreen src="https://app.wooclap.com/UBZAPL/questionnaires/68b1b13144df9e61ac1f4172" style="min-height: 250px; min-width: 500px" width="100%"></iframe>
