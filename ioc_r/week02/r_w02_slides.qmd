...
Click [here](https://app.wooclap.com/ZCRSNB?from=instruction-slide){target="_blank"} to start the quiz.
:::
...
:::{.callout-tip .narrow-callout appearance="simple" title="Quiz Time!"}
Click [here](https://app.wooclap.com/ZCRSNB?from=instruction-slide){target="_blank"} to start the quiz.
:::
