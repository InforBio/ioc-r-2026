...
- **[CRAN](https://cran.r-project.org){target="_blank"}** (Comprehensive R Archive Network) is a network of servers around the world that store identical, up-to-date, versions of code and documentation for R.
- **[Bioconductor](https://bioconductor.org){target="_blank"}** is a specialized repository like CRAN, but focused on bioinformatics. It provides R packages for analyzing genomic and biological data.
:::
...
[from Data to Viz](https://www.data-to-viz.com){target="_blank"} and
[The R Graph Gallery](https://r-graph-gallery.com){target="_blank"} (by Yan Holtz)
:::
...
![(Figure adpated from [QCBS R Workshop Series](https://r.qcbs.ca/workshop03/book-en/grammar-of-graphics-gg-basics.html){target="_blank"}.)](images/ggplot_comp.png)
