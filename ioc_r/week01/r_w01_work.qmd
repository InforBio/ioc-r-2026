...
1. Import the data file "**visceral_fat.csv**".
  ...
  - First, download the `visceral_fat.csv` file via this [link](https://raw.githubusercontent.com/InforBio/ioc-r-2026/refs/heads/main/ioc_r/exos_data/visceral_fat.csv){target='_blank'}.
...
[link](https://raw.githubusercontent.com/InforBio/ioc-r-2026/refs/heads/main/ioc_r/week01/.r_w01_work_corr.R){target='_blank'}