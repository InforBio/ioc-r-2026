...
Importing your first file: [shiny_sample_data.csv](https://raw.githubusercontent.com/InforBio/ioc-r-2026/refs/heads/dev-r/ioc_r/exos_data/shiny_sample_data.csv){target="_blank"}
...
- Google it!
- Forums: Stack Overflow, [Cirad](https://forums.cirad.fr/logiciel-R/){target="_blank"}(francophone), *etc.*
