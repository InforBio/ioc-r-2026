...
- Open your RStudio.
- Create an R script: *File* -> *New File* -> *R Script* or click ![](images/rstudio_newfile.png){width=1.5cm}
- Save script: *Cmd + S* or *Ctrl + S*, name your script, *e.g.*: `test.R`.
- Execute code: Click ![](images/rstudio_runcode.png){width=1.5cm} or press *Cmd + Enter* (*Ctrl + Enter* for Windows)
