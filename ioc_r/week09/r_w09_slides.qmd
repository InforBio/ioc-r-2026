...
Check out the [Quarto tutorial](https://quarto.org/docs/get-started/hello/rstudio.html){target="_blank"}.
:::
...
(Source: [R For Data Science](https://r4ds.hadley.nz/quarto.html#chunk-options){target="_blank"})
...
:::{.callout-note appearance="simple"}
Markdown syntax [cheat sheet](https://www.markdownguide.org/cheat-sheet/){target="_blank"}
:::
