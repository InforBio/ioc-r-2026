...
![](images/execute_chunk.png){width=20%}
...
- If you have specified multiple output formats, you can select the wanted format.
...
**Task:** Select a figure from a scientific paper and recreate it using {*ggplot2*}. Document your workflow in a **Quarto document** to generate a report, and present your work (15 min per person).
