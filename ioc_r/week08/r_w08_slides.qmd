...
::: {.callout-note appearance="simple"}
See [colors in R](https://r-charts.com/colors/) and
...
- Add horizontal (`geom_hline()`), vertical (`geom_vline()`) or diagonal (`geom_abline()`) lines.
...
wrap_plots(plot_scatter(cutoff = 40), plot_scatter(cutoff = 50)) # alternative to combine figs
```
