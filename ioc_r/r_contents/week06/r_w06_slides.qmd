...
Click [here](https://app.wooclap.com/IXBNKE?from=instruction-slide) to start the quiz.
:::
...
- Data import/export with {readr} and {readxl} [cheat sheet](https://github.com/rstudio/cheatsheets/blob/main/data-import.pdf).
:::
...
![](../week09/images/quarto_annot.png)
...
![](../week09/images/quarto_output.png)
:::
:::

:::{.fragment .callout-tip appearance="simple"}
Don't worry about the details for now, we'll break down each part of a Quarto document in Week 9.
:::
