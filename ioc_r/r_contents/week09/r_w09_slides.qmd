...
:::{.callout-note appearance="simple"}
When you **render** a Quarto document, it executes all code chunks in a **fresh R session**,
ignoring objects in your current workspace, and generates the final output file from scratch.
:::
...
- Create your Quarto report by walking through a mini data project.
