...
[link](https://raw.githubusercontent.com/InforBio/ioc-r-2026/refs/heads/main/ioc_r/week07/r_w07_exos.R){target='_blank'}
...
- [data_anonym_struc1_noise.csv](../exos_data/data_anonym_struc1_noise.csv){target='_blank'}
- [data_anonym_struc2_noise.csv](../exos_data/data_anonym_struc2_noise.csv){target='_blank'}
...
The function `ggpairs()` from the {[`GGally`](https://ggobi.github.io/ggally/index.html){target='_blank'}} package
...
How will you reshape the `data1_long` to provide the necessary data for the [`ggpairs()`](https://ggobi.github.io/ggally/articles/ggpairs.html){target='_blank'} function?
