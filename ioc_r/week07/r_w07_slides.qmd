...
::: {.columns}
::: {.column}
- [readr](https://readr.tidyverse.org/){target="_blank"}: import data into R
- [ggplot2](https://ggplot2.tidyverse.org/){target="_blank"}: visualisation
:::
::: {.column}
- [**tidyr**](https://tidyr.tidyverse.org/){target="_blank"}: restructure data
- [**dplyr**](https://dplyr.tidyverse.org/){target="_blank"}: manipulate data
- [stringr](https://stringr.tidyverse.org/){target="_blank"}: manipulate strings
:::
:::
...
# version 1: calculation with nested functions
...
## version 3bis: 
## you can write code in one line if it's not too long
...
What to do if we want to put conditions in a column and expression values in another column?
(*E.g.*: for data visualisation)
:::
